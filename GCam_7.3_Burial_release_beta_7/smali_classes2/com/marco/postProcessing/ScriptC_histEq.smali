.class public Lcom/marco/postProcessing/ScriptC_histEq;
.super Landroid/renderscript/ScriptC;
.source "ScriptC_histEq.java"
...
.method public constructor <init>(Landroid/renderscript/RenderScript;)V
    ...
    invoke-static {}, Lcom/marco/postProcessing/histEqBitCode;->getBitCode32()[B

    move-result-object v0

    invoke-static {}, Lcom/marco/postProcessing/histEqBitCode;->getBitCode64()[B
    ...
    iput-object v0, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__I32:Landroid/renderscript/Element;

    invoke-static {p1}, Landroid/renderscript/Element;->F32(Landroid/renderscript/RenderScript;)Landroid/renderscript/Element;

    move-result-object v0

    iput-object v0, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__F32:Landroid/renderscript/Element;

    invoke-static {p1}, Landroid/renderscript/Element;->U8_4(Landroid/renderscript/RenderScript;)Landroid/renderscript/Element;

    move-result-object p1

    iput-object p1, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__U8_4:Landroid/renderscript/Element;
...
.method public forEach_remaptoRGB(Landroid/renderscript/Allocation;Landroid/renderscript/Allocation;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/marco/postProcessing/ScriptC_histEq;->forEach_remaptoRGB(Landroid/renderscript/Allocation;Landroid/renderscript/Allocation;Landroid/renderscript/Script$LaunchOptions;)V
...
.method public forEach_remaptoRGB(Landroid/renderscript/Allocation;Landroid/renderscript/Allocation;Landroid/renderscript/Script$LaunchOptions;)V
    ...
    iget-object v1, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__U8_4:Landroid/renderscript/Element;
    ...
    iget-object v2, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__U8_4:Landroid/renderscript/Element;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/marco/postProcessing/ScriptC_histEq;->forEach(ILandroid/renderscript/Allocation;Landroid/renderscript/Allocation;Landroid/renderscript/FieldPacker;Landroid/renderscript/Script$LaunchOptions;)V
...
.method public forEach_root(Landroid/renderscript/Allocation;Landroid/renderscript/Allocation;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/marco/postProcessing/ScriptC_histEq;->forEach_root(Landroid/renderscript/Allocation;Landroid/renderscript/Allocation;Landroid/renderscript/Script$LaunchOptions;)V
...
.method public getFieldID_histo()Landroid/renderscript/Script$FieldID;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/marco/postProcessing/ScriptC_histEq;->createFieldID(ILandroid/renderscript/Element;)Landroid/renderscript/Script$FieldID;
...
.method public getInvokeID_createRemapArray()Landroid/renderscript/Script$InvokeID;
    ...
    invoke-virtual {p0, v0}, Lcom/marco/postProcessing/ScriptC_histEq;->createInvokeID(I)Landroid/renderscript/Script$InvokeID;
...
.method public getKernelID_remaptoRGB()Landroid/renderscript/Script$KernelID;
    ...
    invoke-virtual {p0, v1, v2, v0, v0}, Lcom/marco/postProcessing/ScriptC_histEq;->createKernelID(IILandroid/renderscript/Element;Landroid/renderscript/Element;)Landroid/renderscript/Script$KernelID;
...
.method public get_histo()[I
    ...
    iget-object v0, p0, Lcom/marco/postProcessing/ScriptC_histEq;->mExportVar_histo:[I
...
.method public get_remapArray()[F
    ...
    iget-object v0, p0, Lcom/marco/postProcessing/ScriptC_histEq;->mExportVar_remapArray:[F
...
.method public get_size()I
    ...
    iget v0, p0, Lcom/marco/postProcessing/ScriptC_histEq;->mExportVar_size:I
...
.method public invoke_createRemapArray()V
    ...
    invoke-virtual {p0, v0}, Lcom/marco/postProcessing/ScriptC_histEq;->invoke(I)V
...
.method public declared-synchronized set_histo([I)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/marco/postProcessing/ScriptC_histEq;->mExportVar_histo:[I
    ...
    iget-object v2, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__I32:Landroid/renderscript/Element;

    invoke-virtual {p0, v1, v0, v2, p1}, Lcom/marco/postProcessing/ScriptC_histEq;->setVar(ILandroid/renderscript/FieldPacker;Landroid/renderscript/Element;[I)V
    :try_end_0
...
.method public declared-synchronized set_remapArray([F)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/marco/postProcessing/ScriptC_histEq;->mExportVar_remapArray:[F
    ...
    iget-object v1, p0, Lcom/marco/postProcessing/ScriptC_histEq;->__F32:Landroid/renderscript/Element;

    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/marco/postProcessing/ScriptC_histEq;->setVar(ILandroid/renderscript/FieldPacker;Landroid/renderscript/Element;[I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized set_size(I)V
    ...
    :try_start_0
    invoke-virtual {p0, v0, p1}, Lcom/marco/postProcessing/ScriptC_histEq;->setVar(II)V

    iput p1, p0, Lcom/marco/postProcessing/ScriptC_histEq;->mExportVar_size:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
