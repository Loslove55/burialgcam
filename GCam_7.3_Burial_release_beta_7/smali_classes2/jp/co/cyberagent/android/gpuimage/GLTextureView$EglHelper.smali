...
.method private destroySurfaceImp()V
    ...
    iget-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglSurface:Ljavax/microedition/khronos/egl/EGLSurface;
    ...
    iget-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->glTextureViewWeakRef:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v0, v1, v2, v3}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EGLWindowSurfaceFactory;->destroySurface(Ljavax/microedition/khronos/egl/EGL10;Ljavax/microedition/khronos/egl/EGLDisplay;Ljavax/microedition/khronos/egl/EGLSurface;)V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglSurface:Ljavax/microedition/khronos/egl/EGLSurface;
...
.method createGL()Ljavax/microedition/khronos/opengles/GL;
    ...
    iget-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglContext:Ljavax/microedition/khronos/egl/EGLContext;
    ...
    invoke-static {v1}, Ljp/co/cyberagent/android/gpuimage/GLTextureView;->access$700(Ljp/co/cyberagent/android/gpuimage/GLTextureView;)Ljp/co/cyberagent/android/gpuimage/GLTextureView$GLWrapper;
    ...
    invoke-interface {v2, v0}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$GLWrapper;->wrap(Ljavax/microedition/khronos/opengles/GL;)Ljavax/microedition/khronos/opengles/GL;

    move-result-object v0

    :cond_0
    invoke-static {v1}, Ljp/co/cyberagent/android/gpuimage/GLTextureView;->access$800(Ljp/co/cyberagent/android/gpuimage/GLTextureView;)I
    ...
    new-instance v3, Ljp/co/cyberagent/android/gpuimage/GLTextureView$LogWriter;

    invoke-direct {v3}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$LogWriter;-><init>()V
...
.method public createSurface()Z
    ...
    iget-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglDisplay:Ljavax/microedition/khronos/egl/EGLDisplay;

    if-eqz v0, :cond_6

    iget-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglConfig:Ljavax/microedition/khronos/egl/EGLConfig;
    ...
    iget-object v4, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglConfig:Ljavax/microedition/khronos/egl/EGLConfig;

    invoke-virtual {v0}, Ljp/co/cyberagent/android/gpuimage/GLTextureView;->getSurfaceTexture()Landroid/graphics/SurfaceTexture;

    move-result-object v0

    invoke-interface {v1, v2, v3, v4, v0}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EGLWindowSurfaceFactory;->createWindowSurface(Ljavax/microedition/khronos/egl/EGL10;Ljavax/microedition/khronos/egl/EGLDisplay;Ljavax/microedition/khronos/egl/EGLConfig;Ljava/lang/Object;)Ljavax/microedition/khronos/egl/EGLSurface;
    ...
    invoke-static {v2, v3, v0}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->logEglErrorAsWarning(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public finish()V
    ...
    invoke-interface {v0, v2, v3, v4}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EGLContextFactory;->destroyContext(Ljavax/microedition/khronos/egl/EGL10;Ljavax/microedition/khronos/egl/EGLDisplay;Ljavax/microedition/khronos/egl/EGLContext;)V

    :cond_0
    iput-object v1, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglContext:Ljavax/microedition/khronos/egl/EGLContext;
    ...
    iput-object v1, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglDisplay:Ljavax/microedition/khronos/egl/EGLDisplay;
...
.method public start()V
    ...
    iput-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->egl:Ljavax/microedition/khronos/egl/EGL10;
    ...
    iput-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglDisplay:Ljavax/microedition/khronos/egl/EGLDisplay;
    ...
    iput-object v1, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglConfig:Ljavax/microedition/khronos/egl/EGLConfig;
    ...
    :cond_0
    invoke-static {v0}, Ljp/co/cyberagent/android/gpuimage/GLTextureView;->access$400(Ljp/co/cyberagent/android/gpuimage/GLTextureView;)Ljp/co/cyberagent/android/gpuimage/GLTextureView$EGLConfigChooser;
    ...
    invoke-interface {v0, v2, v3, v4}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EGLContextFactory;->createContext(Ljavax/microedition/khronos/egl/EGL10;Ljavax/microedition/khronos/egl/EGLDisplay;Ljavax/microedition/khronos/egl/EGLConfig;)Ljavax/microedition/khronos/egl/EGLContext;

    move-result-object v0

    iput-object v0, p0, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->eglContext:Ljavax/microedition/khronos/egl/EGLContext;
    ...
    invoke-direct {p0, v0}, Ljp/co/cyberagent/android/gpuimage/GLTextureView$EglHelper;->throwEglException(Ljava/lang/String;)V
